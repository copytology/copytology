...
const Hero = () => {
  ...
  return <div className="bg-gradient-to-b from-white to-brand-50 py-16 md:py-24">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-8 animate-slide-up">
              <div className="flex items-center mb-6">
                <div className="bg-brand-100 text-brand-600 font-medium px-3 py-1 rounded-full text-sm">
                  {t('dashboard.copywriting')} {t('challenge.guidelines')}
                </div>
                <div className="ml-auto bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs">
                  {t('dashboard.copywriting')}
                </div>
              </div>
              
              <h3 className="text-lg font-semibold mb-4">{t('challenge.your.challenge')}:</h3>
              <p className="text-gray-600 mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                {language === 'en' ? 
                  ...
                  "Aplikasi produktivitas meluncurkan fitur baru yang membantu pengguna mengatur kalender mereka secara otomatis berdasarkan prioritas."}
              </p>
              ...
              <div className="mt-4 text-center">
                <p className="text-sm text-gray-500">
                  {language === 'en' ? 
                    "Create an account to unlock challenges" :
                    "Buat akun untuk membuka tantangan"}
                </p>
              </div>
            </div>
